...
This guide documents the configuration surface in Spooled PHP SDK 1.0.21.
...
The default `User-Agent` is `spooled-php/1.0.21`, derived from `Spooled\Version::VERSION`.
