...
This guide documents the configuration surface in Spooled PHP SDK 1.2.0.
...
The default `User-Agent` is `spooled-php/1.2.0`, derived from `Spooled\Version::VERSION`.
