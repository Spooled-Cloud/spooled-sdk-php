...
This guide documents the configuration surface in Spooled PHP SDK 1.1.0.
...
The default `User-Agent` is `spooled-php/1.1.0`, derived from `Spooled\Version::VERSION`.
